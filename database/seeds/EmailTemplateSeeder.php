        ...
        DB::table('email_templates')->insert(
            [
                ...
                [
                    'admin_email' => null,
                    'email_type_id' => '22',
                    'title' => 'Employer Email Content - Invitation Answered',
                    'subject' => 'Inivitation Answered',
                    'content' => '<p>Hello,</p>
                    <p><strong><a href="%freelancer_link%">%freelancer_name%</a></strong> %status% the invitation to your job.</p>
                    <p>Click to check the job detail.</p>
                    <p><strong><a href="%job_link%">%job_title%</a></strong></p>
                    <p>%signature%</p>',
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ],
                ...
                [
                    'admin_email' => null,
                    'email_type_id' => '31',
                    'title' => 'Freelancer Email Content - Job Invited',
                    'subject' => 'Job Invited',
                    'content' => '<p>Hello,</p>
                    <p><strong><a href="%employer_link%">%employer_name%</a></strong> invited you to the job <strong><a href="%job_link%">%job_title%</a></strong></p>
                    <p>Click to <strong><a href="%accept_link%">accept</a></strong> or <strong><a href="%decline_link%">decline</a></strong>.</p>
                    <p>%signature%</p>',
                    'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                    'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
                ],
