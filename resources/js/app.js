...
Vue.component(
  "upload-image-cv",
  require("./components/UploadImageCvComponent.vue").default
);
Vue.component(
  "flash_messages",
...
Vue.component(
  "switch_button",
  require("./components/SwitchButton.vue").default
);
Vue.component(
  "user_skills",
  require("./components/ProfileSkillComponent.vue").default
);
Vue.component(
  "freelancer_experience",
  require("./components/ProfileExperienceComponent.vue").default
);
Vue.component(
  "freelancer_education",
  require("./components/ProfileEducationComponent.vue").default
);
Vue.component(
  "freelancer_project",
  require("./components/ProfileProjectComponent.vue").default
);
Vue.component(
  "freelancer_award",
  require("./components/ProfileAwardComponent.vue").default
);
Vue.component(
  "job_attachments",
  require("./components/UploadJobAttachmentComponent.vue").default
);
Vue.component(
  "job_multiple-attachments",
  require("./components/JobMultipleAttachmentComponent.vue").default
);
Vue.component(
  "job_skills",
  require("./components/JobSkillComponent.vue").default
);
Vue.component(
  "private-message",
  require("./components/PrivateMessageComponent.vue").default
);
...
Vue.component(
  "chat-users",
  require("./components/ChatUserComponent.vue").default
);
Vue.component(
  "chat-messages",
...
Vue.component(
  "chat-area",
  require("./components/ChatAreaComponent.vue").default
);
Vue.component(
  "message-center",
...
Vue.component(
  "emoji-textarea",
  require("./components/EmojiTexeareaComponent.vue").default
);
Vue.component(
  "delete",
  require("./components/DeleteRecordComponent.vue").default
);
Vue.component(
  "countdown",
  require("./components/CountDownComponent.vue").default
);
Vue.component(
  "experience",
  require("./components/FreelancerExperienceComponent.vue").default
);
Vue.component(
  "education",
  require("./components/FreelancerEducationComponent.vue").default
);
Vue.component(
  "crafted_project",
  require("./components/FreelancerCraftedProjetcsComponent.vue").default
);
Vue.component("custom-map", require("./components/Map.vue").default);
Vue.component(
  "dashboard-icon",
  require("./components/DashboardIconUploadComponent.vue").default
);
Vue.component(
  "image-attachments",
  require("./components/UploadServiceAttachmentComponent.vue").default
);
Vue.component(
  "freelancer-reviews",
  require("./components/FreelancerReviewsComponent.vue").default
);
Vue.component(
  "location-selector",
  require("./components/LocationSelector.vue").default
);
Vue.component("fullcalendar", require("./components/FullCalendar").default);
Vue.component(
  "calendar-events",
  require("./components/CalendarEvents/CalendarEvents.vue").default
);
...
jQuery(document).ready(function() {
  jQuery(document).on("click", ".wt-back", function(e) {
    e.preventDefault();
    jQuery(".wt-back")
      .parents(".wt-messages-holder")
      .removeClass("wt-openmsg");
  });
  ...
  jQuery(
    ".wt-navigation ul li.menu-item-has-children, .wt-navdashboard ul li.menu-item-has-children"
  ).prepend(
    '<span class="wt-dropdowarrow"><i class="lnr lnr-chevron-right"></i></span>'
  );
  jQuery(".wt-navigation ul li.menu-item-has-children span").on(
    "click",
    function() {
      jQuery(this)
        .parent("li")
  ...
  jQuery(
    ".wt-navigation ul li.menu-item-has-children > a, .wt-navigation ul li.page_item_has_children > a"
  ).on("click", function() {
  ...
  jQuery(".wt-navdashboard ul li.menu-item-has-children").on(
    "click",
    function() {
  ...
  function fixedNav() {
    ...
    $(window).scroll(function() {
      ...
      if (
        isDashboardPages &&
        $pscroll + $(window).height() > $(document).height() - 120
      ) {
  ...
  jQuery(".filter-records").on("keyup", function() {
    ...
    jQuery(this)
      .parents("fieldset")
      .siblings("fieldset")
      .find(".wt-checkbox:contains(" + content + ")")
      .show();
    jQuery(this)
      .parents("fieldset")
      .siblings("fieldset")
      .find(".wt-checkbox:not(:contains(" + content + "))")
      .hide();
  });
  ...
  tinymce.init({
    ...
    statusbar: false,
    toolbar1:
      "undo redo | insert | styleselect | bold italic | alignleft aligncenter alignright alignjustify code",
    image_advtab: true,
...
/*admin calendar*/
if (document.getElementById("all_availability")) {
  var role = "admin";
  const vmHeader = new Vue({
    ...
    created() {
      axios.get("/" + role + "/getAllAvailabilities").then((response) => {
    ...
    methods: {
      ...
      createNewEvent(event) {
        if (this.selectedEvent) {
          ...
          this.availability_selected_date = moment(ev.startDate).format(
            "DD-MM-YYYY"
          );
          this.availability_selected_end_date = moment(ev.endDate).format(
            "DD-MM-YYYY"
          );
          ...
          this.user_name = ev.first_name + " " + ev.last_name;
      ...
      updateEvent(e) {
        ...
        var self = this;
        let register_Form = document.getElementById(
          "availability_dashboard_form"
        );
        let form_data = new FormData(register_Form);
        axios
          .post("/" + role + "/updateCalendarAvailability", form_data)
          .then(function(response) {
            self.reloadCalendar();
            thistoast.success(
              " ",
              "Updated : <br>" +
                self.availability_title +
                " " +
                self.availability_content +
                "<br>" +
                self.start +
                " - " +
                self.end
      ...
      deleteEvent(e) {
        ...
        axios
          .post("/" + role + "/deleteAvailability", form_data)
          .then(function(response) {
            self.reloadCalendar();
      ...
      saveNewEventAvailability(e, busy) {
        ...
        axios
          .post("/" + role + "/saveCalendarAvailability", form_data)
          .then(function(response) {
            self.reloadCalendar();
            if (busy) {
              thistoast.error(
      ...
      createList(event) {
        ...
        newElem.children[0]
          .querySelector("input")
          .setAttribute("name", "start_date[" + elem.length + "]");
        newElem.children[1]
          .querySelector("input")
          .setAttribute("name", "end_date[" + elem.length + "]");
  ...
  const vmHeader = new Vue({
    ...
    methods: {
      ...
      createNewEvent(date) {
        ...
        if (
          (!this.selectedEventDrag &&
            this.clickedDate == "" &&
            this.clickedEndDate == "") ||
          (this.clickedDate != "" && this.clickedEndDate != "")
        ) {
        ...
        var newObj = {
          start:
            this.availability_selected_date +
            " " +
          ...
          content:
            this.availability_content != "" ? this.availability_content : "•",
      ...
      saveNewEventAvailability(e, busy) {
        ...
        //this.events.push(newObj);
        axios
          .post("/" + role + "/saveCalendarAvailability", newObj)
          .then(function(response) {
            availability_start_time = "";
            availability_end_time = "";
            availability_title = "";
      ...
      updateEvent(e) {
        ...
        //this.events.push(newObj);
        axios
          .post("/" + role + "/updateCalendarAvailability", updObj)
          .then(function(response) {
            // availability_start_time = '';
            // availability_end_time = '';
            // availability_title = '';
      ...
      deleteEvent(e) {
        ...
        axios
          .post("/" + role + "/deleteCalendarEvent", form_data)
          .then(function(response) {
            self.reloadCalendar();
            thistoast.success("Success", "Successfully deleted!");
            setTimeout(function(self) {
      ...
      onEventClick(event) {
        ...
        var formatdatestart = moment(startdate[0], "YYYY-MM-DD").format(
          "DD-MM-YYYY"
        );
        var formatdateend = moment(enddate[0], "YYYY-MM-DD").format(
          "DD-MM-YYYY"
        );
  ...
  const searchHomePage = new Vue({
    ...
    mounted: function() {
      ...
      if (this.$refs["profession"]) {
        this.profession_id = this.$refs["profession"].attributes[
          "data-value"
        ].value;
      }
      ...
      if (this.$refs["time"]) {
        this.selectedTime.HH = this.$refs["time"].attributes[
          "data-hours"
        ].value;
        this.selectedTime.mm = this.$refs["time"].attributes[
          "data-minutes"
        ].value;
      }
      if (this.$refs["rate"]) {
    ...
    data: {
      ...
      search_type: page.attributes["attr-type"]
        ? page.attributes["attr-type"].value
        : "freelancer",
      straddress: new URLSearchParams(window.location.search).get("location"),
      radius: "",
      profession_id: "",
  ...
  const registration = new Vue({
    ...
    methods: {
      checkoutStripe(plan_id) {
        ...
        stripe
          .redirectToCheckout({
            ...
            successUrl:
              APP_URL + "/register/checkout_complete/" + this.stripe_token,
            cancelUrl: APP_URL,
          })
      ...
      changeBkgroundImages(step) {
        ...
        if (element.length > 0) {
          ...
          if (step >= 1 && step <= this.max_background_images) {
            ...
            currentImg =
              step % this.max_background_images > 0
                ? step % this.max_background_images
                : 1;
          }

          element
            .removeClass(this.all_background_classes)
            .addClass("main-wrapper-register-" + currentImg);
        }
      },
      ...
      checkStep1: function(e) {
        ...
        let form_data = new FormData(register_Form);
        axios
          .post(APP_URL + "/register/form-step1-custom-errors", form_data)
          .then(function(response) {
            self.next();
          })
          .catch(function(error) {
            if (error.response.data.errors.first_name) {
              self.form_step1.first_name_error =
                error.response.data.errors.first_name[0];
              self.form_step1.is_first_name_error = true;
            }
            if (error.response.data.errors.last_name) {
              self.form_step1.last_name_error =
      ...
      checkStep2: function(error_message) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/register/form-step2-custom-errors", form_data)
          .then(function(response) {
            self.next();
          })
          .catch(function(error) {
            ...
            if (error_data.pin_date_revalid) {
              self.form_step2.pin_date_revalid_error =
                error_data.pin_date_revalid[0];
            ...
            if (error_data.emp_cqc_rating_date) {
              self.form_step2.emp_cqc_rating_date_error =
                error_data.emp_cqc_rating_date[0];
              self.form_step2.is_emp_cqc_rating_date_error = true;
            }
            if (error_data.emp_cqc_rating) {
              self.form_step2.emp_cqc_rating_error =
                error_data.emp_cqc_rating[0];
            ...
            if (error_data.direct_booking) {
              self.form_step2.direct_booking_error =
                error_data.direct_booking[0];
              self.form_step2.is_direct_booking_error = true;
            }

            if (error_data.termsconditions) {
              self.form_step2.termsconditions_error =
                error_data.termsconditions[0];
          ...
          .then(function(response) {
            ...
            if (response.data.type == "success") {
              ...
              if (response.data.email_error)
                self.form_errors.push(response.data.email_error);
              if (response.data.password_error)
                self.form_errors.push(response.data.password_error);
      ...
      verifyCode: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/register/verify-user-code", form_data)
          .then(function(response) {
            self.loading = false;
            if (response.data.type == "success") {
              self.next();
      ...
      loginRegisterUser: function() {
        var self = this;
        axios
          .post(APP_URL + "/register/login-register-user")
          .then(function(response) {
            if (response.data.type == "success") {
              window.location.href =
                APP_URL + "/" + response.data.role + "/dashboard";
            } else if (response.data.type == "error") {
      ...
      updateAddressLocation: function(place) {
        ...
        document.getElementById("city").value = data.postal_town
          ? data.postal_town
          : data.locality
          ? data.locality
          : "";
  ...
  const vmskillList = new Vue({
    ...
    methods: {
      ...
      deleteChecked: function(msg, text) {
        var deleteIDs = jQuery("#checked-val input:checkbox:checked")
          .map(function() {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-checked-skills", {
                ids: deleteIDs,
              })
              .then(function(response) {
                if (response.data.type == "success") {
    ...
    methods: {
      ...
      deleteChecked: function(msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-checked-dpts", {
                ids: deleteIDs,
              })
              .then(function(response) {
                if (response.data.type == "success") {
  ...
  const vmpageList = new Vue({
    ...
    methods: {
      ...
      submitPage: function(msg) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store-page", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
      ...
      getPageOption: function() {
        ...
        if (segment_str == "/admin/pages/edit-page/" + id) {
          let self = this;
          axios
            .post(APP_URL + "/admin/get-page-option", {
              page_id: id,
            })
            .then(function(response) {
              if (response.data.type == "success") {
      ...
      deleteChecked: function(msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-checked-pages", {
                ids: deleteIDs,
              })
              .then(function(response) {
                if (response.data.type == "success") {
    ...
    methods: {
      ...
      deleteChecked: function(msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-checked-rev-options", {
                ids: deleteIDs,
              })
              .then(function(response) {
                if (response.data.type == "success") {
    ...
    methods: {
      ...
      deleteChecked: function(msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-checked-delivery-time", {
                ids: deleteIDs,
              })
              .then(function(response) {
                if (response.data.type == "success") {
    ...
    methods: {
      ...
      deleteChecked: function(msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-checked-response-time", {
                ids: deleteIDs,
              })
              .then(function(response) {
                if (response.data.type == "success") {
    ...
    methods: {
      ...
      deleteChecked: function(msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-checked-cats", {
                ids: deleteIDs,
              })
              .then(function(response) {
                if (response.data.type == "success") {
    ...
    methods: {
      ...
      deleteChecked: function(msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-checked-badges", {
                ids: deleteIDs,
              })
              .then(function(response) {
                if (response.data.type == "success") {
    ...
    methods: {
      ...
      deleteChecked: function(msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-checked-langs", {
                ids: deleteIDs,
              })
              .then(function(response) {
                if (response.data.type == "success") {
    ...
    methods: {
      ...
      deleteChecked: function(msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-checked-locs", {
                ids: deleteIDs,
              })
              .then(function(response) {
                if (response.data.type == "success") {
      ...
      notificationSystem: {
        options: {
          ...
          info: {
            ...
            onClosing: function(instance, toast, closedBy) {
              freelancerProfile.showCompleted(
                Vue.prototype.trans("lang.profile_update_success")
              );
            },
          },
        },
    ...
    methods: {
      initEmployerData() {
        if (document.getElementById("employer_data")) {
          this.setting =
            document.getElementById("initialSetting") !== null
              ? document.getElementById("initialSetting").value
              : "";
          this.appoSlotTime =
            document.getElementById("initialAppoSlotTimes") !== null
              ? document.getElementById("initialAppoSlotTimes").value
              : "";
          this.paymentTerm =
            document.getElementById("initialPaymentTerms") !== null
              ? document.getElementById("initialPaymentTerms").value
              : "";
        }
      },
      ...
      submitProfileSettings: function() {
        ...
        axios
          .post(APP_URL + "/freelancer/profile-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.next();
            } else if (response.data.type == "error") {
      ...
      submitFreelancerProfile: function() {
        ...
        axios
          .post(APP_URL + "/freelancer/store-profile-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
      ...
      submitSupportProfile: function() {
        ...
        let form_data = new FormData(profile_data);
        axios
          .post(APP_URL + "/support/store-profile-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.showInfo(Vue.prototype.trans("lang.saving_profile"));
            } else if (response.data.type == "error") {
      ...
      submitExperienceEduction: function() {
        ...
        axios
          .post(APP_URL + "/freelancer/store-experience-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
      ...
      submitPaymentSettings: function() {
        ...
        axios
          .post(APP_URL + "/freelancer/store-payment-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
      ...
      submitAwardsProjects: function() {
        ...
        axios
          .post(APP_URL + "/freelancer/store-project-award-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.showInfo(response.data.message);
            } else if (response.data.type == "error") {
      ...
      submitEmployerProfile: function() {
        ...
        let form_data = new FormData(profile_data);
        axios
          .post(APP_URL + "/employer/store-profile-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
      ...
      submitAdminProfile: function() {
        ...
        let form_data = new FormData(profile_data);
        axios
          .post(APP_URL + "/admin/store-profile-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.showInfo(response.data.process);
              setTimeout(function() {
      ...
      submitProjectOffer: function(id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/store/project-offer", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.loading = false;
      ...
      submitReport: function(id, report_type) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/submit-report", self.report)
          .then(function(response) {
            if (response.data.type == "success") {
              self.showMessage(response.data.message);
            } else if (response.data.type == "error") {
      ...
      getWishlist: function() {
        ...
        axios
          .post(APP_URL + "/profile/get-wishlist", {
            slug: slug,
          })
          .then(function(response) {
...
if (document.getElementById("settings")) {
  const VueSettings = new Vue({
    ...
    mounted: function() {
      ...
      //Delete Social
      var count_social_length = jQuery(".social-icons-content").find(
        ".wrap-social-icons"
      ).length;
      ...
      //Delete Search
      var count_social_length = jQuery(".search-content").find(".wrap-search")
        .length;
      count_social_length = count_social_length - 1;
      this.social.count = count_social_length;
    ...
    methods: {
      getHomeSectionDisplaySetting: function() {
        let self = this;
        axios
          .get(APP_URL + "/admin/get-section-display-setting")
          .then(function(response) {
      ...
      getPrimaryColorDisplaySetting: function() {
        let self = this;
        axios
          .get(APP_URL + "/admin/get-theme-color-display-setting")
          .then(function(response) {
            if (response.data.enable_theme_color == "true") {
              self.enable_theme_color = true;
              self.enable_color_text = Vue.prototype.trans(
                "lang.primary_color"
              );
      ...
      getChatDisplaySetting: function() {
        let self = this;
        axios
          .get(APP_URL + "/admin/get-chat-display-setting")
          .then(function(response) {
      ...
      addSocial: function() {
        this.socials.push(
          Vue.util.extend({}, this.social, this.social.count++)
        );
      },
      ...
      addSearchItem: function() {
        this.searches.push(
          Vue.util.extend({}, this.search, this.search.count++)
        );
      },
      ...
      submitGeneralSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitChatSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/chat-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      uploadDashboardIcons: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/upload-icons", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitThemeStylingSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/theme-styling-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitFooterSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/footer-settings", data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitAccessType: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/access-type-settings", data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitSocialSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/social-settings", data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitSearchMenu: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/search-menu", data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitCommisionSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/commision-settings", data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitPaypalSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/payment-settings", data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitStripeSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/stripe-payment-settings", data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitEmailSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/email-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitHomeSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/home-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitSectionSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/section-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitServicesSectionSettings: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/service-section-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      clearCache: function() {
        ...
        this.$swal({
          ...
          if (result.value) {
            self.loading = true;
            axios
              .post(APP_URL + "/admin/clear-cache", form_data)
              .then(function(response) {
                if (response.data.type == "success") {
                  self.loading = false;
                  self.$swal(
                    Vue.prototype.trans(lang.deleted),
                    Vue.prototype.trans(lang.cache_cleared),
                    Vue.prototype.trans(lang.success)
                  );
                } else {
                  self.loading = false;
      ...
      clearAllCache: function() {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .get(APP_URL + "/admin/clear-allcache")
              .then(function(response) {
                if (response.data.type == "success") {
                  self.loading = false;
                  self.$swal(
                    Vue.prototype.trans(lang.cleared),
                    Vue.prototype.trans(lang.cache_cleared),
                    Vue.prototype.trans(lang.success)
                  );
                } else {
      ...
      importUpdate: function(success_title, success_text) {
        this.$swal({
          ...
          if (result.value) {
            self.loading = true;
            axios
              .get(APP_URL + "/admin/import-updates")
              .then(function(response) {
                if (response.data.type == "success") {
                  self.loading = false;
      ...
      submitInnerPage: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/innerpage-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      getRegistrationSettings: function() {
        let self = this;
        axios
          .get(APP_URL + "/admin/get/registration-settings")
          .then(function(response) {
      ...
      getSitePaymentOptions: function() {
        let self = this;
        axios
          .get(APP_URL + "/admin/get/site-payment-option")
          .then(function(response) {
      ...
      submitBreadcrumbs: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/breadcrumbs-settings", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      getBreadcrumbsSettings: function() {
        let self = this;
        axios
          .post(APP_URL + "/admin/get/breadcrumbs-settings")
          .then(function(response) {
    ...
    methods: {
      ...
      deleteAccount: function(event) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/profile/settings/delete-user", form_data)
              .then(function(response) {
                if (response.data.type === "warning") {
                  self.showError(response.data.msg);
                } else {
                  setTimeout(
                    ...
                    self.showInfo(response.data.acc_del),
                    1000
                  );
      ...
      deleteUser: function(id) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/delete-user", {
                user_id: id,
              })
              .then(function(response) {
                if (response.data.type == "success") {
      ...
      getUserEmailNotification: function() {
        let self = this;
        axios
          .get(APP_URL + "/profile/settings/get-user-notification-settings")
          .then(function(response) {
            if (response.data.type == "success") {
      ...
      getSearchableSettings: function() {
        let self = this;
        axios
          .get(APP_URL + "/profile/settings/get-user-searchable-settings")
          .then(function(response) {
            if (response.data.type == "success") {
  ...
  const vmpostJob = new Vue({
    ...
    methods: {
      ...
      submitJob: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/job/post-job", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.loading = false;
      ...
      updateJob: function(id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/job/update-job", form_data)
          .then(function(response) {
            self.loading = false;
            if (response.data.type == "success") {
      ...
      getSettings: function() {
        ...
        var slug = segment_array[segment_array.length - 1];
        axios
          .post(APP_URL + "/job/get-job-settings", {
            slug: slug,
          })
          .then(function(response) {
            if (response.data.type == "success") {
  ...
  const vmpostJob = new Vue({
    ...
    methods: {
      ...
      setBooking(e) {
        ...
        this.events.push({
          start:
            this.convertDateForFormatCalendar(this.selecteddate) +
            " " +
            this.start,
          end:
            this.convertDateForFormatCalendar(this.selecteddate_end) +
            " " +
            this.end,
          title: this.title,
          content: this.description,
      ...
      submitJob: function() {
        ...
        let form_data = new FormData(register_Form);
        var self = this;
        form_data.append("breaks", JSON.stringify(self.breaks));
        axios
          .post(APP_URL + "/job/post-job", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
      ...
      updateEvent(e) {
        ...
        //this.events.push(newObj);
        axios
          .post("/employer/updateCalendarEvent", form_data)
          .then(function(response) {
            self.reloadCalendar();
            self.showInfo(Vue.prototype.trans("lang.job_updating"));
            self.clickedDate = false;
  ...
  const vmpostJob = new Vue({
    ...
    created: function() {
      ...
      if (sel_recurring_date) {
        self.recurring_date = sel_recurring_date;
        self.is_recurring = true;
      }
      axios
        .get(APP_URL + "/job/get-job-appointment/" + job_id)
        .then(function(response) {
          let job = response.data;
          console.log(job.breaks);
          self.job_appo_slot_times = job.job_appo_slot_times;
          self.job_adm_catch_time = job.job_adm_catch_time;
          self.job_adm_catch_time_interval = job.job_adm_catch_time_interval;
          self.home_visits = job.home_visits;
          self.breaks = job.breaks;
        });
    },
    methods: {
      convertDateForFormatCalendar(date) {
  ...
  const jobVue = new Vue({
    ...
    methods: {
      ...
      check_auth: function(job) {
        axios
          .get(APP_URL + "/check-proposal-auth-user", { params: { job } })
          .then((response) => {
      ...
      submitJobProposal: function(id, user_id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/proposal/submit-proposal", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.loading = false;
      ...
      submitRefund: function(job_id) {
        ...
        axios
          .post(APP_URL + "/admin/submit-user-refund", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.loading = false;
              self.showMessage(response.data.message);
      ...
      submitFeedback: function(id, job_id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/user/submit-review", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.loading = false;
      ...
      submitDispute: function(id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/freelancer/store-dispute", form_data)
          .then(function(response) {
            console.log(response.data);
            if (response.data.type == "success") {
              self.loading = false;
    ...
    methods: {
      ...
      submitPackage: function() {
        if (this.selected_role == 3) {
          if ((this.package.conneects, this.package.skills)) {
            ...
            if (!this.package.conneects)
              this.form_errors.push(
                Vue.prototype.trans("lang.connects_required")
              );
            if (!this.package.skills)
              this.form_errors.push(trans("lang.skills_required"));
          ...
          if ((this.package.jobs, this.package.featured_jobs)) {
            ...
            if (!this.package.jobs)
              this.form_errors.push(
                Vue.prototype.trans("lang.no_jobs_required")
              );
            if (!this.package.featured_jobs)
              this.form_errors.push(
                Vue.prototype.trans("lang.no_featurejobs_required")
              );
            this.form_errors.forEach((element) => {
              this.showError(element);
            });
      ...
      getOptions: function() {
        ...
        if (window.location.pathname == "/admin/packages/edit/" + slug) {
          axios
            .post(APP_URL + "/package/get-package-options", {
              slug: slug,
            })
            .then(function(response) {
              console.log(response.data);
      ...
      getPurchasePackage: function(id) {
        var self = this;
        axios
          .get(APP_URL + "/package/get-purchase-package")
          .then(function(response) {
            if (response.data.type == "success") {
      ...
      submitStripeFrom: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/addmoney/stripe", data)
          .then(function(response) {
            console.log(response.data);
            if (response.data.type == "success") {
              self.loading = false;
  ...
  new Vue({
    ...
    methods: {
      ...
      submitPayoutsDetail: function(id) {
        ...
        form_data.append("id", id);
        axios
          .post(APP_URL + "/user/update-payout-detail", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.loading = false;
              self.showMessage(response.data.message);
      ...
      getUserPayoutSettings: function() {
        var self = this;
        axios
          .get(APP_URL + "/user/get-payout-detail")
          .then(function(response) {
            if (response.data.type == "success") {
  ...
  const vservices = new Vue({
    ...
    methods: {
      ...
      submitService: function() {
        ...
        var self = this;
        axios
          .post(APP_URL + "/services/post-service", form_data)
          .then(function(response) {
            if (response.data.type == "success") {
              self.loading = false;
              ...
              document.addEventListener("iziToast-closing", function(data) {
                if (data.detail.id == "info_notify") {
                  self.showCompleted(response.data.message);
                  window.location.replace(
                    APP_URL + "/freelancer/services/posted"
                  );
                }
              });
            } else {
      ...
      changeStatus: function(id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/services/change-status", {
            status: status,
            id: id,
          })
          .then(function(response) {
      ...
      getSettings: function() {
        ...
        if (segment_str == "/freelancer/dashboard/edit-service/" + id) {
          axios
            .post(APP_URL + "/service/get-service-settings", {
              id: id,
            })
            .then(function(response) {
              if (response.data.type == "success") {
      ...
      updateService: function(id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/service/update-service", form_data)
          .then(function(response) {
            self.loading = false;
            if (response.data.type == "success") {
              self.showInfo(response.data.progress);
                  ...
                  if (response.data.type == "success") {
                    ...
                    document.addEventListener("iziToast-closing", function(
                      ...
                      if (data.detail.id == "info_notify") {
                        self.showCompleted(response.data.message);
                        window.location.replace(
                          APP_URL + "/employer/services/cancelled"
                        );
                      }
                    });
                  } else if (response.data.type == "error") {
          ...
          .then(function(response) {
            if (response.data.type == "success") {
              ...
              setTimeout(function() {
                self.$refs.myModalRef.hide();
                window.location.replace(
                  APP_URL + "/employer/services/completed"
                );
              }, 1000);
            } else {
              self.loading = false;
      ...
      check_auth: function(url) {
        var self = this;
        axios
          .get(APP_URL + "/check-service-auth-user")
          .then(function(response) {
          ...
          .catch((error) => {
            if (error.response.status == 422) {
              ...
              if (error.response.data.errors.refundable_user_id) {
                self.showError(
                  error.response.data.errors.refundable_user_id[0]
                );
              }
            }
          });
  ...
  if (!timerangeWindow) {
    ...
    if (input.val() !== "") {
      ...
      var matches = timerange.match(
        /([0-9]{1}):([0-9]{2}) (\bAM\b|\bPM\b)-([0-9]{1}):([0-9]{2}) (\bAM\b|\bPM\b)/
      );
      if (!matches) {
        matches = timerange.match(
          /([0-9]{2}):([0-9]{2}) (\bAM\b|\bPM\b)-([0-9]{2}):([0-9]{2}) (\bAM\b|\bPM\b)/
        );
      }
      if (!matches) {
        matches = timerange.match(
          /([0-9]{1}):([0-9]{2}) (\bAM\b|\bPM\b)-([0-9]{2}):([0-9]{2}) (\bAM\b|\bPM\b)/
        );
      }
      if (!matches) {
        matches = timerange.match(
          /([0-9]{2}):([0-9]{2}) (\bAM\b|\bPM\b)-([0-9]{1}):([0-9]{2}) (\bAM\b|\bPM\b)/
        );
      }
      if (matches.length === 7) {
        range = {
    ...
    $(".timerangepicker-container").on(
      ...
      function() {
        ...
        value.text(incrementHour(value.text(), 12, 1));
      }
    );
    ...
    $(".timerangepicker-container").on(
      ...
      function() {
        var value = $(this).siblings(".value");
        value.text(decrementHour(value.text(), 12, 1));
      }
    );
...
$(document).ready(function() {
  setTimeout(function() {
    $("#post_job .vuecal__cell-date").after(
      '<button class="bookbutton">+</button>'
    );
  ...
  $(document).on(
    "click",
    "#post_job .vuecal__menu, #post_job.vuecal__title-bar",
    function() {
  ...
  $(document).on(
    "click",
    "#employer_availability .vuecal__menu, #employer_availability .vuecal__title-bar,     #freelancer_availability .vuecal__menu, #freelancer_availability .vuecal__title-bar",
    function() {
...
$(document).ready(function() {
  ...
  if (btns.length > 0) {
    btns.on("click", function(event) {
      ...
      if (
        $("#" + content).length > 0 &&
        $("#" + content).hasClass("content-full-less-paragraph__more")
      ) {
