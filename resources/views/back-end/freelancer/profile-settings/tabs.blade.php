<div class="wt-dashboardtabs">
    <ul class="wt-tabstitle nav navbar-nav">
        <li class="nav-item">
            <a class="{{{ \Request::route()->getName()==='personalDetail'? 'active': '' }}}" href="{{{ route('personalDetail') }}}">{{{ trans('lang.profile_detail') }}}</a>
        </li>
        {{--<li class="nav-item">--}}
        ...
        {{--</li>--}}
        <li class="nav-item">
            <a class="{{{ \Request::route()->getName()==='resetPassword'? 'active': '' }}}" href="{{{ route('resetPassword', ['role' => 'freelancer']) }}}">{{{ trans('lang.reset_pass') }}}</a>
        </li>
        {{--<li class="nav-item">--}}
