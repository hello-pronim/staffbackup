...
<section class="wt-haslayout wt-dbsectionspace wt-insightuser" id="dashboard">
    ...
    <div class="row">
        ...
        {{--@endphp--}}
        {{--<tr>--}}
        {{--<td data-th="Project title"><span class="bt-content"><a target="_blank" href="{{{ url('job/'.$project->slug) }}}">{{{ $project->title }}}</a></span>
        </td>--}}
        ...
        {{--</span>--}}
        {{--</td>--}}
        {{--<td data-th="Project cost"><span class="bt-content">{{ !empty($symbol['symbol']) ? $symbol['symbol'] : '£' }}{{$project->price}}</span>
        </td>--}}
        {{--<td data-th="Actions">--}}
        {{--<span class="bt-content">--}}
        {{--<div class="wt-btnarea">--}}
        {{--<a href="{{{ url('employer/dashboard/job/'.$project->slug.'/proposals') }}}"
        class="wt-btn">{{ trans('lang.view_detail') }}</a>--}}
        {{--</div>--}}
        {{--</span>--}}
        {{--</td>--}}
        {{--</tr>--}}
        ...
        <div id="post_job_dashboard" class="post_job_dashboard-wrapper">
            <div class="dashboard-vuecal-wrapper dashboard-vuecal-wrapper-employer">
                <vue-cal ref="vuecal" :time-from="0 * 60" :time-to="24 * 60"
                    :disable-views="['years', 'year', 'week', 'day']" default-view="month" events-on-month-view="short"
                    :events="events" :on-event-click="onEventClick" @cell-click="changeSelectedDate">
                </vue-cal>
            </div>
            <div class="scrolToCalend">
                <div class="wt-tabscontent tab-content">
                    ...
                    'post_job_dashboard_form', '@submit.prevent'=>'submitJob']) !!}
                    <div class="wt-dashboardbox" v-if="job_id==''">
                        ...
                        padding-top: 5px;"><img src="{{url('images/icons/jobpost.png')}}" alt=""></div>
                            <h2 v-if="event_id != ''"
                                style=" font-weight: bold; text-transform: uppercase; font-family: AganeLight; color:#263b65; margin: 7px 0;">
                                Update post event</h2>
                            <h2 v-if="event_id == ''"
                                style=" font-weight: bold; text-transform: uppercase; font-family: AganeLight; color:#263b65; margin: 7px 0;">
                                {{ trans('lang.post_job') }}</h2>
                        </div>
                        <div class="wt-dashboardboxcontent  classScrollTo">
                            ...
                            <div class="form-group" id="listDates">
                                <div class="isDay">
                                    <div class="form-group form-group-half">
                                        <span class="wt-select">
                                            <date-picker :config="{format: 'DD-MM-YYYY'}" class="form-control"
                                                name="start_date[0]"
                                                placeholder="{{ trans('lang.start_date') }}" value=""
                                                v-model="selecteddate"></date-picker>
                                        </span>
                                    </div>
                                    <div class="form-group form-group-half" v-if="selecteddate!=''">
                                        <span class="wt-select">
                                            <date-picker :config="{format: 'DD-MM-YYYY'}" class="form-control"
                                                name="end_date[0]" placeholder="{{ trans('lang.end_date') }}"
                                                value="" v-model="selecteddate_end"></date-picker>
                                        </span>
                                    </div>
                                </div>
                                <div class="getIsDay" v-if="event_id == ''" v-for="d in 6" style="display:none">
                                    ...
                                    <div class="form-group form-group-half">
                                        <span class="wt-select">
                                            <date-picker :config="{format: 'DD-MM-YYYY'}" class="form-control"
                                                placeholder="{{ trans('lang.end_date') }}" value="">
                                            </date-picker>
                                        </span>
                                    </div>
                                </div>
                                <button type="button" class="wt-btn" v-if="event_id == ''" v-on:click="createList"
                                    v-if="addDay!=6" id="addDay">add day</button>
                            </div>
                            ...
                            <div class="form-group form-group-half">
                                ...
                                <div class="wt-divtheme wt-userform wt-userformvtwo">
                                    <div class="form-group">
                                        <vue-timepicker name="booking_start" required format="HH:mm" v-model="start">
                                        </vue-timepicker>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group form-group-half">
                                ...
                                <div class="wt-divtheme wt-userform wt-userformvtwo">
                                    <div class="form-group">
                                        <vue-timepicker name="booking_end" required format="HH:mm" v-model="end">
                                        </vue-timepicker>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group form-group-half float-right"
                                    v-if="recurring_date != '' && is_recurring != false">
                                    <span class="wt-select">
                                        <date-picker :config="{format: 'DD-MM-YYYY'}" class="form-control"
                                            name="recurring_end_date" placeholder="Last date recurring" requare value=""
                                            v-model="recurring_end_date"></date-picker>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group form-group-half" v-if="this.job_appo_slot_times=='Other'">
                                    <input id="other_appo" type="text" class="form-control" name="job_appo_slot_times[]" placeholder="Other Slot Time">
                                </div>
                                ...
                                <div class="form-group form-group-half m-0 p-0" v-if="this.job_adm_catch_time=='Yes'">
                                    <div class="form-group" v-bind:class="[this.job_adm_catch_time_interval=='Other' ? 'form-group-half' : '']">
                                        <div class="wt-select">
                                        {!! Form::select('job_adm_catch_time_interval[]', $arrJob_Adm_catch_time_interval, null, array( 'placeholder' => "Admin Catch Up Provided (interval)",'v-model'=>'job_adm_catch_time_interval')) !!}
                                        </div>
                                    </div>
                                    <div class="form-group form-group-half" v-if="this.job_adm_catch_time_interval=='Other'">
                                        <input id="other_appo" type="text" class="form-control"  name="job_adm_catch_time_interval[]">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="wt-select">
                            ...
                            <div class="form-group wt-tabsinfo">
                                <div class="wt-tabscontenttitle">
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            <input type="text" name="title" class="form-control"
                                                placeholder="{{ trans('lang.job_title') }}" v-model="booking_title">
                                        </div>

                                        <div class="form-group">
                                            {!! Form::textarea('description', null, ['class' =>'form-control',
                                            'placeholder' => trans('lang.job_dtl_note') , 'v-model'=>'booking_content'])
                                            !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="left-inner-addon">
                                                <span>£</span>
                                                {!! Form::text('project_rates', null, array('class' => 'form-control ratePicker', 'placeholder' => 'Your rate - per hour', 'min'=>'0', 'v-model'=>'project_rates'))
                                                !!}
                                            </div>
                                        </div>
                                ...
                                <div class="wt-formtheme wt-userform wt-userformvtwo calendarbookingform"
                                    style=" display: none;" @click.prevent="preventClick">
                                    <div class="form-group " style="margin-top: 25px;">
                                        <label>Booking Title / Job Title</label>
                                        <input type="text" name="booking_title" disabled class="form-control "
                                            placeholder="Booking Title" v-model="booking_title">
                                    </div>
                                    <div class="form-group" style="margin-top: 25px;">
                                        <label>Booking description</label>
                                        {!! Form::textarea('booking_content', null, ['placeholder' => 'Booking
                                        description' , 'v-model'=>'booking_content']) !!}
                                    </div>
                            ...
                            <div class="wt-jobcategories wt-tabsinfo">
                                ...
                                <div class="form-group form-group-half">
                                    {!! Form::number( 'number', $user->number, ['class' =>'form-control', 'placeholder'
                                    => trans('lang.number')] ) !!}
                                </div>
                                ...
                                {{--<div class="form-group ">--}}
                                {{--<input type="text" class="form-control" name="org_name" value="{{$user->emp_contact}}"
                                placeholder="Organisation name">--}}
                                {{--</div>--}}
                                {{--<div class="form-group form-group-half">--}}
                                {{--<input id="organisation_position" type="text" class="form-control" name="organisation_position" value="{{$user->emp_pos}}"
                                placeholder="Position">--}}
                                {{--</div>--}}
                                {{--<div class="form-group form-group-half">--}}
                                {{--<input id="organisation_email" type="email" class="form-control" name="organisation_email" value="{{$user->emp_email}}"
                                placeholder="Email">--}}
                                {{--</div>--}}
                                {{--<div class="form-group form-group-half">--}}
                                {{--<input id="organisation_contact" type="text" class="form-control" name="organisation_contact" value="{{$user->emp_telno}}"
                        ...
                        <div class="wt-updatall" v-if="event_id != ''">
                            ...
                            '@click'=>'updateEvent', 'id'=>'submit-profile']) !!}
