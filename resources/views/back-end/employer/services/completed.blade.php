                                ...
                                <td data-th="Action">
                                    <span class="bt-content">
                                        <div class="wt-actionbtn">
                                            <a href="{{{url('employer/service/'.$service['id'].'/'.$service->pivot->id.'/completed')}}}"
                                                class="wt-viewinfo wt-btnhistory">{{ trans('lang.show_history') }}</a>
                                        </div>
                                    </span>
                                </td>
                            </tr>
                            <b-modal ref="myModalRef-{{ $service->pivot->id }}" class="wt-uploadrating" hide-footer
                                title="{{{trans('lang.service_feedback')}}}" v-cloak>
