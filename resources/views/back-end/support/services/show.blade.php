                        ...
                        <div class="wt-jobdetailscontent">
                            <div class="wt-userlistinghold wt-featured wt-proposalitem">
                                ...
                                <figure class="wt-userlistingimg">
                                    <img src="{{{asset(Helper::getProfileImage($freelancer->id))}}}"
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                <span class="wt-select">
                                                    ...
                                                    'serviceStatus('.$service->id.', '.$id.', '.Auth::user()->id.',
                    ...
                    <div class="wt-projecthistory">
                        ...
                        <div class="wt-historycontent la-jobdetails-holder">
                            <private-message :placeholder="'{{ trans('lang.ph_job_dtl') }}'"
                                :upload_tmp_url="'{{url('service/upload-temp-message_attachments')}}'" :id="'{{$id}}'"
                                :recipent_id="'{{$pivot_service->user_id}}'" :project_type="'service'">
                            </private-message>
                        </div>
                    </div>
                </div>
                ...
                <fieldset>
                    ...
                    <div class="form-group wt-btnarea">
                        <a class="wt-btn" href="javascript:void(0);"
                            v-on:click='submitFeedback({{$freelancer->id}}, {{$id}})'>{{ trans('lang.btn_send_feedback') }}</a>
                    </div>
                </fieldset>
            </form>
        </div>
