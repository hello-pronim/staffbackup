    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
            ...
            <div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
                @if (file_exists(resource_path('views/extend/back-end/support/jobs/tabs.blade.php')))
                    @include('extend.back-end.support.jobs.tabs')
                @else
                    @include('back-end.support.jobs.tabs')
                @endif
