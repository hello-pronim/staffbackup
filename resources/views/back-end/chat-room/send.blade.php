                            ...
                            <div class="wt-jobdetailscontent">
                                <div class="wt-userlistinghold wt-featured wt-userlistingvtwo">
                                    <div class="wt-userlistingcontent">
                                        ...
                                        <input type="hidden" id="receiver_name" value="{{$user->first_name.' '.$user->last_name}}">
                                        <div class="wt-contenthead">
                                            <div class="wt-title">
                                                <span class="mr-10">To: </span>
                                                <span>
                                                    <a href="{{{ url('profile/'.$user->slug) }}}">
                                                        <img class="avatar-sm" src="{{ asset($user->profile->avater ? '/uploads/users/' . $user->id . '/' . $user->profile->avater : 'images/user-login.png') }}" alt="{{ trans('lang.profie_img') }}">
                                        ...
                                        <div class="wt-rightarea">
                                            <input type="hidden" id="message_type" value="{{isset($_GET['invite'])?$_GET['invite']:''}}">
                                            <textarea class="form-control" id="message-area" name="body" placeholder="Type message here" v-model="messageText">
                                            </textarea>
                                        </div>
