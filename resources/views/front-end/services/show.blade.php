                        ...
                        <div class="wt-servicesingle">
                                ...
                                <ul class="wt-userlisting-breadcrumb">
                                    <li>
                                        <span>
                                            ...
                                            {{{ $rating }}}/<i>5</i>&nbsp;({{{ !empty($reviews) ? $reviews->count() : ''}}}
                                            {{ trans('lang.feedbacks') }})
                                        </span>
                                    </li>
                                    <li>
                                        <span>
                            ...
                            <div class="wt-freelancers-info">
                                <div id="{{$enable_slider}}" class="wt-servicesslider owl-carousel">
                                    ...
                                    <figure class="item">
                                        <img src="{{{asset(Helper::getImageWithSize('uploads/services/'.$seller->id, $attachment, 'medium'))}}}"
                                ...
                                <div id="wt-servicesgallery" class="wt-servicesgallery owl-carousel">
                                    ...
                                    <div class="item">
                                        <figure><img src="{{{asset($image)}}}" alt="img description"></figure>
                                    </div>
                                    @endforeach
                                </div>
                                @endif
                        ...
                        <div class="wt-clientfeedback">
                            ...
                            <div class="wt-userlistinghold wt-userlistingsingle">
                                <figure class="wt-userlistingimg">
                                    <img src="{{ asset(Helper::getProfileImage($review->user_id)) }}"
                                        alt="{{{ trans('Employer') }}}">
                                </figure>
                                <div class="wt-userlistingcontent">
                                    <div class="wt-contenthead">
                                        <div class="wt-title">
                                            <a href="{{{ url('profile/'.$user->slug) }}}">@if ($user->user_verified ==
                                                1)<i class="fa fa-check-circle"></i>@endif
                                                {{{ Helper::getUserName($review->user_id) }}}</a>
                                            <h3>{{{ $service->title }}}</h3>
                                        </div>
                                        <ul class="wt-userlisting-breadcrumb">
                                            ...
                                            <li>
                                                <span>
                                                    <img src="{{{asset(Helper::getLocationFlag($service->location->flag))}}}"
                                                        alt="{{{ trans('lang.flag_img') }}}">
                                                    {{{ $service->location->title }}}
                                                </span>
                                            </li>
                                            @endif
                                            <li><span><i class="far fa-calendar"></i>
                                                    {{ Carbon\Carbon::parse($service->created_at)->format('M Y') }} -
                                                    {{ Carbon\Carbon::parse($service->updated_at)->format('M Y') }}</span>
                                            </li>
                                            <li>
