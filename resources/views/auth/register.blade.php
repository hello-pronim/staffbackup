...
'front-end.master'), ['needShortFooterCards' => true])
@section('content')
@php
...
trans('lang.pro_info');
$reg_two_employer_title = !empty($register_form) && !empty($register_form[0]['step2-title']) ?
$register_form[0]['step2-title'] : trans('lang.pro_info_employer');
$reg_two_support_title = !empty($register_form) && !empty($register_form[0]['step2-title']) ?
$register_form[0]['step2-title'] : trans('lang.pro_info_support');
                            ...
                            <div class="wt-joinforms">
                                        ...
                                        <ul class="wt-accordionhold wt-formaccordionhold accordion"
                                            ...
                                            <li style="width:33%; <?php if ($key != 3) {
                                                ...
                                                <div class="wt-accordiontitle role-{{$role['role_type']}}"
                                                    id="headingOne" style="height: 69px; border: 1px solid #ddd;"
                                                    ...
                                                    <span class="wt-radio">
                                                        <input id="wt-company-{{$key}}" type="radio" name="role"
                                                            ...
                                                            v-model="user_role" v-on:change="selectedRole(user_role)">
                                ...
                                <fieldset class="wt-registerformgroup">
                                    <div class="wt-haslayout" v-show="step === 1" v-cloak>
                                        ...
                                        <div v-if="user_role=='employer'" class="form-group form-group-half">
                                            <input id="practice_code" type="text" class="form-control"
                                                name="practice_code" placeholder="Practice Code"
                                                @input="practiceCodeChanging"
                                                v-bind:class="{ 'is-invalid': form_step2.is_practice_code_error }">
                                            <span class="help-block" v-if="form_step2.practice_code_error">
                                ...
                                <div class="wt-haslayout" v-show="step === 2" v-cloak>
                                    <fieldset class="wt-registerformgroup">
                                        ...
                                        <div class="form-group form-group-half" v-if="user_role=='employer'">
                                            <input id="emp_website" type="url" class="form-control"
                                                :disabled="user_role=='employer'" name="emp_website"
                                                placeholder="{{{ trans('lang.emp_website') }}}"
                                                v-bind:class="{ 'is-invalid': form_step2.emp_website_error }">
                                            <span class="help-block" v-if="form_step2.emp_website_error">
                                                <strong v-cloak>@{{form_step2.emp_website_error}}</strong>
                                            </span>
                                        </div>
                                        <div class="form-group form-group-half">
                                            <gmap-autocomplete class="form-control" placeholder="Address"
                                                id="straddress" name="straddress"
                                                @place_changed="updateAddressLocation($event)"
                                                :select-first-on-enter="true" :disabled="user_role=='employer'"
                                                v-bind:class="{ 'is-invalid': form_step2.straddress_error }">
                                                <template v-slot:input="slotProps">
                                                    <v-text-field outlined ref="input"
                                                        v-on:listeners="slotProps.listeners"
                                                        v-on:attrs="slotProps.attrs">
                                                    </v-text-field>
                                                </template>
                                            </gmap-autocomplete>
                                            <input v-if="user_role=='employer'" type="hidden" id="straddress-emloyer"
                                                name="straddress" value="">
                                            <span class="help-block" v-if="form_step2.straddress_error">
                                        ...
                                        <div class="form-group form-group-half">
                                            ...
                                            <span class="help-block" v-if="form_step2.city_error">
                                                <strong v-cloak>@{{form_step2.city_error}}</strong>
                                            </span>
                                        </div>
                                        <div class="form-group form-group-half" v-if="user_role!='employer'">
                                            <input id="phone" type="tel" class="form-control" name="telno"
                                                placeholder="{{{ trans('lang.phone') }}}"
                                                :disabled="user_role=='employer'"
                                                v-bind:class="{ 'is-invalid': form_step2.telno_error }">
                                            <span class="help-block" v-if="form_step2.telno_error">
                                        ...
                                        <div class="form-group form-group-half">
                                            ...
                                            <span class="help-block" v-if="form_step2.postcode_error">
                                    ...
                                    <fieldset class="wt-formregisterstart">
                                        ...
                                        <div class="wt-accordiondetails " v-if="is_show">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group form-group-half">
                                                    <input id="emp_contact" type="text" class="form-control"
                                                        name="emp_contact"
                                                        placeholder="{{{ trans('lang.emp_contact') }}}"
                                                        v-bind:class="{ 'is-invalid': form_step2.emp_contact_error }">
                                                    <span class="help-block" v-if="form_step2.emp_contact_error">
                                                        <strong v-cloak>@{{form_step2.emp_contact_error}}</strong>
                                                    </span>
                                                </div>
                                                <div class="form-group form-group-half">
                                                    <input id="emp_telno" type="tel" class="form-control"
                                                        name="emp_telno" placeholder="{{{ trans('lang.emp_telno') }}}"
                                                        v-bind:class="{ 'is-invalid': form_step2.emp_telno_error }">
                                                    <span class="help-block" v-if="form_step2.emp_telno_error">
                                                        <strong v-cloak>@{{form_step2.emp_telno_error}}</strong>
                                                    </span>
                                                </div>
                                                <div class="form-group form-group-half">
                                                    <input id="emp_pos" type="url" class="form-control" name="emp_pos"
                                                ...
                                                <div class="form-group form-group-half">
                                                    <span class="wt-select">
                                                        {!! Form::select('emp_cqc_rating_date', $cqc_ratings_date, null,
                                                        array('placeholder' => trans('lang.emp_cqc_rating_date'),
                                                        'class' => 'form-group', 'v-bind:class' => '{ "is-invalid":
                                                        form_step2.emp_cqc_rating_date_error }')) !!}
                                                    </span>
                                                    <span class="help-block" v-if="form_step2.emp_cqc_rating_error">
                                                        <strong
                                                            v-cloak>@{{form_step2.emp_cqc_rating_date_error}}</strong>
                                                    </span>

                                                </div>
                                                <div class="form-group form-group-half">
                                                    <span class="wt-select">
                                                        {!! Form::select('emp_cqc_rating', $cqc_ratings, null,
                                                        array('placeholder' => trans('lang.emp_cqc_rating'), 'class' =>
                                                        'form-group', 'v-bind:class' => '{ "is-invalid":
                                                        form_step2.emp_cqc_rating_error }')) !!}
                                                    </span>
                                                ...
                                                <div v-if="user_role=='freelancer'">
                                                    <div class="form-group form-group-half">
                                                        <input type="text" class="halfWidth form-control" name="pin"
                                                            placeholder="Pin"
                                                            v-bind:class="{ 'is-invalid': form_step2.pin_error }">
                                                        <span class="help-block" v-if="form_step2.pin_error">
                                                            <strong v-cloak>@{{form_step2.pin_error}}</strong>
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <date-picker :config="{format: 'DD-MM-YYYY'}" value=""
                                                            class="form-control" name="pin_date_revalid"
                                                        ...
                                                        <span class="help-block"
                                                            ...
                                                            <strong
                                                                v-cloak>@{{form_step2.pin_date_revalid_error}}</strong>
                                                    </div>
                                                </div>
                                                <br>
                                                ...
                                                <div v-if="insurancecheckbox">
                                                    ...
                                                    <div class="form-group form-group-half">
                                                        <input id="org_name" type="text" class="form-control org-name"
                                                            name="org_name" placeholder="Name">
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <input id="organisation_position" type="text"
                                                            class="form-control" name="organisation_position"
                                                            placeholder="Position">
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <input id="organisation_email" type="email" class="form-control"
                                                            name="organisation_email" placeholder="Email">
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <input id="organisation_contact" type="text"
                                                            class="form-control" name="organisation_contact"
                                                ...
                                                <div class="form-group form-group-half ">
                                                    ...
                                                    <input type="file" name="certs" class="form-control"
                                                        accept=".pdf, image/*,.doc,.docx">
                                                </div>
                                                <div class="form-group form-group-half">
                                                    {!! Form::select('appo_slot_times[]', $arrAppo_slot_times, null,
                                                    array('v-model'=>'appoSlotTime', 'class'=>'halfWidth', 'placeholder'
                                                    => "Appointment Slot Times")) !!}
                                                </div>
                                                <div class="form-group form-group-half" v-if="appoSlotTime=='Other'">
                                                    <input id="other_appo" type="text" class="form-control halfWidth"
                                                ...
                                                <div class="form-group">
                                                    <span class="wt-select">
                                                        ...
                                                        array('v-model'=>'paymentTerm', 'placeholder' => "Payment
                                                        Terms")) !!}
                                                    </span>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="hourly_rate_desc" type="text" class="form-control"
                                                        name="hourly_rate_desc" placeholder="Additional info">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="wt-accordiondetails" v-if="user_role!='employer'"
                                            ...
                                            <div class="form-group form-group-half" v-if="user_role=='employer'">
                                                <date-picker :config="{format: 'DD/MM/YYYY'}" id="date_available"
                                                    value="" class="form-control" name="date_available"
                                                    placeholder="{{{ trans('lang.date_available') }}}"
                                                    v-bind:class="{ 'is-invalid': form_step2.date_available_error }">
                                                </date-picker>
                                                <span class="help-block" v-if="form_step2.date_available_error">
                                            ...
                                            <div class="form-group form-group-half" v-if="user_role=='freelancer'">
                                                <span class="wt-select">
                                                    ...
                                                    \App\User::getProfessionsByRole(App\Role::FREELANCER_ROLE), null,
                                                    array('placeholder' => "Profession")) !!}
                                                </span>
                                            </div>
                                            ...
                                            <div class="form-group form-group-half" v-if="user_role=='support'">
                                                <span class="wt-select">
                                                    {!! Form::select('profession',
                                                    \App\User::getProfessionsByRole(App\Role::SUPPORT_ROLE), null,
                                                    array('placeholder' => "Profession")) !!}
                                                </span>
                                            </div>
                                            ...
                                            <div class="form-group"
                                                ...
                                                <span class="help-block" v-if="form_step2.exp_years_error">
                                            ...
                                            <div class="form-group form-group-half" v-if="user_role=='freelancer'">
                                                <multiselect v-model="itsoftware" :options="itsoftware_options"
                                                    :searchable="false" :close-on-select="false"
                                                    :clear-on-select="false" :preserve-search="false"
                                                    :show-labels="false" :multiple="true" placeholder="Computer Systems"
                                                    name="itsoftware" class="multiselect-upd">
                                                    <template slot="selection" slot-scope="{ values, search, isOpen }">
                                                        <span class="multiselect__single"
                                                            v-if="values.length &amp;&amp; !isOpen">@{{ values.length }}
                                                            option@{{ values.length != 1 ? 's' : '' }} selected</span>
                                                    </template>
                                                </multiselect>
                                                <select name="itsoftware[]" style="display:none;" multiple>
                                                    <option v-for="value in itsoftware" :value="value" selected>
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group form-group-half" v-if="user_role=='freelancer'">
                                                <span class="wt-select">
                                                    {!! Form::select('special_interests[]', $arrSpecialInterests, null,
                                                    array('v-model'=>'specialInterest','placeholder' => "Special
                                                    Interest")) !!}
                                                </span>
                                            </div>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td><input type="text" class="form-control"
                                                                name="profQualLevel[]" placeholder="Level"></td>
                                                        <td><input type="text" class="form-control"
                                                                name="profQualName[]" placeholder="Name"></td>
                                                        <td><input type="text" class="form-control"
                                                                name="profQualPlace[]" placeholder="Place of Study">
                                                        </td>
                                                        <td><input type="number" min="0" class="form-control"
                                                                name="profQualYear[]" placeholder="Year"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="form-group form-group-half" v-if="user_role=='freelancer'">
                                                ...
                                                <input type="file" name="prof_qual_cert" class="form-control"
                                                    accept=".pdf, image/*,.doc,.docx">
                                            </div>
                                            ...
                                            <div class="form-group form-group-half"
                                                ...
                                                <input type="file" name="mand_training" class="form-control"
                                                    accept=".pdf, image/*,.doc,.docx">
                                            </div>
                                            ...
                                            <div class="form-group form-group-half"
                                                ...
                                                <input type="file" name="occup_health" class="form-control"
                                                    accept=".pdf, image/*,.doc,.docx">
                                            </div>
                                                ...
                                                <div class="wt-checkboxholder">
                                                    <span class="wt-checkbox">
                                                        <input id="insurancecheckbox" type="checkbox"
                                                            name="insurancecheckbox" v-model="insurancecheckbox">
                                                        <label for="insurancecheckbox"><span>Do you have professional
                                                                indemnity insurance?</span></label>
                                                    </span>
                                                </div>
                                            </div>

                                            <div class="form-group form-group-half" v-if="insurancecheckbox"
                                                v-if="user_role=='freelancer'">
                                                <div>Professional Indemnity Insurance:</div>
                                                <input type="file" name="prof_ind_cert" class="form-control"
                                                    accept=".pdf, image/*,.doc,.docx">
                                            </div>
                                            ...
                                            <div class="form-group"
                                                ...
                                                <div class="wt-checkboxholder">
                                                    <span class="wt-checkbox">
                                                        <input id="dbscheck" type="checkbox" name="dbscheck" checked=""
                                                            v-model="dbscheck">
                                            ...
                                            <div class="form-group form-group-half" v-if="dbscheck">
                                                ...
                                                <input type="file" name="cert_of_crbdbs" class="form-control"
                                                    accept=".pdf, image/*,.doc,.docx">
                                            </div>
                                            ...
                                            <div class="form-group form-group"
                                                ...
                                                <span class="wt-select">
                                                    {!! Form::select('drive_license', array('Yes'=>'Yes', 'No'=>'No'),
                                                    null, array('placeholder' => "Do you have a full driving licence?"))
                                                    !!}
                                                </span>
                                            </div>
                                            ...
                                            <div class="form-group form-group" v-if="user_role=='support'">
                                                <span class="wt-select">
                                                    {!! Form::select('endorsements', array('Yes'=>'Yes', 'No'=>'No'),
                                                    null, array('placeholder' => "Do you have any endorsements?")) !!}
                                                </span>
                                            </div>
                                    ...
                                    <fieldset class="wt-termsconditions">
                                        <div class="wt-checkboxholder">
                                            <span class="wt-checkbox">
                                                ...
                                                <label for="termsconditions"><span>Agree to T&Cs and
                                                        Privacy</span></label>
                                        ...
                                        <div class="form-group-n">
                                            ...
                                            <div v-if="user_role!='employer'">
                                                ...
                                                <div class="form-group form-group-half" style="margin-top: 23px;">
                                                    <span class="wt-select">
                                                        {!! Form::select('right_of_work', array('Yes'=>'Yes',
                                                        'No'=>'No'), null, array('placeholder' => "Right to work")) !!}
                                                    </span>
                                                </div>

                                                <div class="form-group form-group-half">
                                                    <div>Passport or Visa:</div>
                                                    <input type="file" name="passport_visa" class="form-control"
                                                        v-bind:class="{ 'is-invalid': form_step2.is_passport_visa }"
                                                        accept=".pdf, image/*,.doc,.docx">
                                                    <span class="help-block" v-if="form_step2.is_passport_visa">
                                                ...
                                                <div class="form-group form-group-half">
                                                    <span class="wt-select halfWidth">
                                                        {!! Form::select('nationality', $arrNationals, null,
                                                        array('placeholder' => "Nationality")) !!}
                                                    </span>
                                                </div>
                                            ...
                                            <div v-if="user_role=='employer'">
                                                <span class="wt-select">
                                                    {!! Form::select('plan_id', $subscribe_options, null,
                                                    array('placeholder' => "Select subscription ",
                                                    'v-model'=>'subscription' ,'class' => 'form-group', 'v-on:change' =>
                                ...
                                <div class="wt-gotodashboard" v-show="step === 4" v-cloak>
                                    ...
                                    <fieldset class="wt-formregisterstart">
                                        ...
                                        <div v-if="user_role=='freelancer' || user_role=='support'">
                                            ...
                                            <div class="form-group form-group-half price-currency-wrap"
                                                v-if="user_role=='freelancer' || user_role=='support'">
                                                <input id="hourly_rate" type="number" class="form-control price-input"
                                                    name="hourly_rate" min="0" placeholder="Hourly Rate">
                                            ...
                                            <div class="form-group form-group-half" style="margin-bottom: -2px;"
                                                ...
                                                <span class="wt-checkbox"
                                                    ...
                                                    <span class="wt-checkbox">
                                                        <input id="hourly_rate_negotiable" type="checkbox"
                                                            name="hourly_rate_negotiable" checked="">
                                                        <label for="hourly_rate_negotiable"><span> Rate
                                                                Negotiable?</span></label>
                                                    </span>
                                                </span>
                                            </div>
                                            ...
                                            <div class="form-group form-group-half">
                                                <span class="wt-select">
                                                    {!! Form::select('direct_booking', array('Direct Bookings
                                                    accepted'=>'Direct Bookings accepted', 'Direct Bookings not
                                                    accepted'=>'Direct Bookings not accepted'), null,
                                                    array('placeholder' => "Direct Bookings")) !!}
                                                </span>
                                            </div>
                                ...
                                <div class="wt-gotodashboard" v-show="step === 5" v-cloak>
                                    ...
                                    <fieldset class="wt-formregisterstart" style="width: 100%;">
                                        <div class="form-group form-group-half">
                                            <span class="wt-select">
                                                {!! Form::select('payment_option', $payment_options, null,
                                                array('placeholder' => "Select Payment Option",
                                                'v-model'=>'choosen_payment' ,'class' => 'form-group', 'v-bind:class' =>
                                                '{ "is-invalid": form_step2.payment_option_error }', 'v-on:change' =>
                                                'selectedPayment(choosen_payment)')) !!}
                                            </span>
                                            <input v-if="choosen_payment=='Other'" type="text"
                                                name="payment_option_other" class="form-control"
